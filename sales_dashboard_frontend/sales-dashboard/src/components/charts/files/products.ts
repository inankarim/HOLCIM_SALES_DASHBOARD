...
export const PRODUCT_CODES: ProductCode[] = ["PLC", "PLC+", "POW", "HOLCIM", "HWP", "HCG"];
...
export function resolveProductCode(raw: string | null | undefined): ProductCode | null {
  if (!raw) return null;
